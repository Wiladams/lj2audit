...
--[[
static const int AUDIT_WORD(nr) ((uint32_t)((nr)/32))
static const int AUDIT_BIT(nr)  (1 << ((nr) - AUDIT_WORD(nr)*32))
...
static const int AUDIT_ARCH_MIPS64N32	(EM_MIPS|__AUDIT_ARCH_64BIT|\
				 __AUDIT_ARCH_CONVENTION_MIPS64_N32)
static const int AUDIT_ARCH_MIPSEL64	(EM_MIPS|__AUDIT_ARCH_64BIT|__AUDIT_ARCH_LE)
static const int AUDIT_ARCH_MIPSEL64N32	(EM_MIPS|__AUDIT_ARCH_64BIT|__AUDIT_ARCH_LE|\
				 __AUDIT_ARCH_CONVENTION_MIPS64_N32)
...
static const int audit_feature_valid(x)		((x) >= 0 && (x) <= AUDIT_LAST_FEATURE)
static const int AUDIT_FEATURE_TO_MASK(x)	(1 << ((x) & 31)) /* mask for uint32_t */
--]]
